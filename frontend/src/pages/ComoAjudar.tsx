...
const ComoAjudar: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="px-6 py-12 max-w-4xl mx-auto min-h-[80vh]">

        <section className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-[#532b2a] mb-4">Faça parte desta construção</h1>
          <p className="mx-auto text-base text-gray-700 max-w-2xl">Escolha como prefere contribuir. Cada tijolo, cada real e cada hora de trabalho contam.</p>
        </section>
