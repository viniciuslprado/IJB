      ...
      <header className="app-header" style={headerStyle}>
        <div style={{ maxWidth: 1280, width: '100%', margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'space-between', alignItems: 'center' }}>
          <div className="brand-left" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div className="brand-badge" style={{ width: 44, height: 44, borderRadius: 8, background: theme.colors.primary, display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-hidden="true">
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div className="brand-title" style={{ fontWeight: 800, color: theme.colors.primary }}>Instituto João de Barros</div>
              </div>
              <div className="brand-subtitle" style={{ fontSize: 12, color: theme.colors.muted }}>Franca — SP</div>
            </div>
          </div>

          <nav className="app-nav" style={navStyle} aria-label="main navigation">
            <Link to="/">Home</Link>
            ...
            <div style={{ marginLeft: 8 }}>
              ...
              <BotaoCTA className="cta-header" onClick={() => setDonateOpen(true)}>DOE AGORA</BotaoCTA>
            </div>
          </nav>
        </div>
      </header>
